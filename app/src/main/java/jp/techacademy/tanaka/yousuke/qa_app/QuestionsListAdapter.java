...
/**
 * モデルクラスをリストに表示するQuestionsListAdapterクラス
 * Lesson4やLesson6でListViewが登場しましたがそれらと同じように実装します。
 * 異なる点はリスト用に自分で作成したレイアウトファイルを使っているところです。それ以外は一緒です。

 ImageViewに設定するBitmapはbyteの配列から生成します。
 */
